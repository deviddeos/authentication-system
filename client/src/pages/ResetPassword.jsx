        ...
        <div className='flex justify-between mb-8' onPaste={handlePaste}>
          {Array(6).fill(0).map((_, index) => (
            <input type='text' maxLength='1' key={index} required
              ...
              onInput={(e) => handleInput(e, index)}  // for automatic change to input in one box of OTP
              onKeyDown={(e) => handleKeyDown(e, index)} // fro backspace then automatically point to the input fields
            />
          ))}
        </div>
